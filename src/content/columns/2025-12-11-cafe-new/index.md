...
### ⑤ 店頭サインの手作り制作と設置
 *** 
![店頭サインのmachikadocafeの文字](./cafe_new_panel.jpg)
頭の印象をより統一するため、木製サインもあわせて制作しました。
質感のあるウッドボードに、立体的な店名ロゴを組み合わせ、あたたかみのある雰囲気に仕上げています。

このサインは既製品ではなく、カフェの世界観に合うよう 一から手作りしたオリジナル。
文字の厚みや配置バランスを細かく調整し、店頭のライトに当たったときにほどよく影が落ちるよう設計しました。

設置の際は高さや角度を調整しながら、「入口から見たときに一番目に入る位置」を店主さんと相談して決めています。
